...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		//	return err
		//}
		tags := map[string]string{"stage":"dev", "component":"api"}

		_, err := ec2.NewVpc(ctx,"api-dev-vpc", &ec2.VpcArgs{
		...
		vpc, err := ec2.LookupVpc(ctx, &ec2.LookupVpcArgs{Tags: tags})
		if err != nil {
			return err
		}
		...
		_, err = ecs.NewCluster(ctx, "app-cluster", nil)
		if err != nil {
			return err
		}
